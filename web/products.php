...
<div class="about"> 
		<div class="container">
			...
			<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk ORDER BY idproduk DESC");
			 ...
			 <div class="col-md-3 abt-sec span_1_of_4">
              ...
              ?>
						...
						<ul class="pagination">
							...
							<li><a href="products.php">3</a></li>
							<li><a href="products.php">4</a></li>
							<li><a href="products.php">5</a></li>
							<li><a href="products.php" aria-label="Next"><span aria-hidden="true">»</span></a></li>
						 </ul>
					    </nav>
		</div>
</div>
